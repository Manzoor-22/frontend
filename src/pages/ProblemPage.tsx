            ...
            <div className="h-[calc(100vh-60px)] overflow-hidden bg-black">
                ...
                >
                    ...
                    >
                        ...
                        <div className="description-body relative w-full h-[calc(100%-50px)] overflow-y-auto bg-[#070F2B]">
                    ...
                    <div className="flex flex-col h-[calc(100%-16px)] min-w-[calc(20%-8px)] mr-[8px] flex-grow">
                        ...
                        <div
                            id="console"
                            className="flex justify-end items-center bg-[#282828] w-full h-[50px] rounded-lg overflow-hidden border border-borders"
                        >
                            <div
