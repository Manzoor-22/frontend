...
const MainHeading = ({ data }: { data?: MainHeadingData }) => {
    ...
    return (
        <>
            <div className="fixed w-full h-[60px] bg-black border-b border-borders flex felx-row z-[200]">
                <Link to="/" className=" select-none">
                    <div
                        id="logo-cont"
                        className="inline-block text-[24px] font-bold italic mx-[30px] mt-[12px]"
                    >
                        <span className="text-blue-900 bg-clip-text bg-gradient-to-r from-white-800 to-white-300 text-3xl font-bold">
                            AlgoArena
                        </span>
                    </div>
                </Link>
                <Link to="/problemset" className="select-none">
                    <div
                        id="logo-cont"
                        className="inline-block text-[20px] font-bold mx-[36px] mt-[16px]"
                    >
                        <span className="text-transparent bg-clip-text bg-white font-extrabold">
                            Practice
                        </span>
                    </div>
                </Link>
